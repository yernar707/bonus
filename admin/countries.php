	...
	<nav class="navbar navbar-inverse nav-top">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				<li><a href="/bonus">Beast Mode</a></li>
				<?php
		...
		<div class="auth-form col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin: 50px auto;">
			...
			<div>
				<table>
					...
					<?php
						$query = 'SELECT cname, population FROM "dbSchema"."Country"';
								...
								while ($row = pg_fetch_assoc($result)) {?>
									<tr style="border-bottom: 1px solid #efefef;">
										...
										<td style="padding: 3px;">
											<form method="POST" action="php/delete-country.php">
												<input type="hidden" required="" name="cname" value="<?php echo $row['cname']; ?>">
					...
					?>
					<tr>
						<form method="POST" action="php/add-country.php">
							<td>
								<input style="width: 80%; text-align: center;" type="text" placeholder="Country" name="cname">
							</td>
							<td>
								<input style="width: 80%; text-align: center;" type="text" placeholder="Population" name="population">
							</td>
							<td>
